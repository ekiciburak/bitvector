...
Lemma mk_list_true_cons2 : forall (b : bool) (l : list bool), 
          ...
          + destruct (list_cases_all_true l).
            * rewrite H1.
              ...
              Reconstr.reasy (@RAWBITVECTOR_LIST.length_mk_list_true, 
                 ...
                 @RAWBITVECTOR_LIST.mk_list_true_cons2) Reconstr.Empty.
            * rewrite !false_val_list.
              rewrite !N2Nat.inj_double.
        ...
        - simpl in *.
          ...
          + rewrite skipn_true_val_list.
            ...
            Reconstr.rexhaustive1 (@Coq.NArith.Nnat.N2Nat.inj_succ_double,
              ...
              @RAWBITVECTOR_LIST.mk_list_true_app,
              @RAWBITVECTOR_LIST.mk_list_true_cons2, 
...
Proof. intro l.
        ...
        - cbn in *. easy.
        - cbn. 
          Reconstr.rsimple (@RAWBITVECTOR_LIST.mk_list_true_cons2, 
...
Fixpoint ule_list_big_endian (x y : list bool) :=
  ...
  | _, nil => false 
  | xi :: x', yi :: y' =>
    ((eqb xi yi) && (ule_list_big_endian x' y'))
     || ((negb xi) && yi)
  end. 
...
Definition bv_ule (a b : bitvector) :=
  ...
  + assert (ugt_cons_true : forall (b : list bool), 
    ...
    - induction t as [| h2 t2 IH].
      ...
      * assert (ugt_cons_false : forall (b : list bool), 
            ...
            { pose proof (@ugt_list_big_endian_cons false) as ugt_list_big_endian_false.
  ...
  + assert (ult_cons_false : forall (b : list bool), 
    ...
    - induction t as [| h2 t2 IH].
      ...
      * assert (ult_cons_true : forall (b : list bool), 
            ...
            { pose proof (@ult_list_big_endian_cons true) as ult_list_big_endian_true.
              intros. specialize (@ult_list_big_endian_true b0 (mk_list_true (length b0)) H0). 
              pose proof mk_list_true_cons2 as mk_list_true_cons2. 
              specialize (@mk_list_true_cons2 true b0).
              rewrite mk_list_true_cons2. apply ult_list_big_endian_true.  
            } destruct h2. 
        { assert (forall (b : list bool), 
            true :: b <> mk_list_true (length (true :: b)) -> 
            b <> mk_list_true (length b)).
            { intros. rewrite mk_list_true_cons2 in H0. 
              unfold not. intros. unfold not in H0. rewrite <- H1 in H0.
              now contradict H0. }
          ...
          + rewrite orb_true_iff in H. destruct H.
            ...
            ++ rewrite andb_true_iff, negb_true_iff in H.
              ...
              -- rewrite orb_true_iff, andb_true_iff, negb_true_iff, eqb_true_iff in *.
                ...
                ** rewrite andb_true_iff in H. now destruct H.
              -- rewrite orb_true_iff, andb_true_iff, negb_true_iff, eqb_true_iff in *.
                 destruct H0.
...
Proof.
  ...
  + simpl. easy.
  + intros y. case y.
    - intros. case h in *; case t in *; easy.
    - intros b l. simpl. 
      case t in *.
      * simpl. case l in *.
...
Proof.
  ...
  + intros y. case y.
    ...
    - intros b l. simpl.
      ...
      * rewrite !orb_true_iff, !andb_true_iff. intro. destruct H.
        { destruct H. apply IHx in H0. apply Bool.eqb_prop in H.
          rewrite H. rewrite H0. left. rewrite eqb_true_iff. split; easy. }
        { destruct H. apply negb_true_iff in H. subst. right. split; easy. }
Qed. 
...
Proof.
  ...
  case_eq (size x =? size y); intros.
  - apply ule_list_uge_list in H0. unfold bv_uge. rewrite (@eqb_sym (size x) (size y)) in H. 
    rewrite H. apply H0. 
  - now contradict H0. 
Qed.
...
Proof.
  ...
  + case b2 in *.
    - rewrite orb_true_iff, andb_true_iff, eqb_true_iff.
      now left.
    - easy.
  + case b2 in *.
    - simpl in H. case b1 in *; easy.
...
Proof.
  ...
  + case_eq a.
    - intros.
      ...
      apply (@ule_list_big_endian_cons true l (mk_list_true (length l)) IHl).
  ...
  + intros y. case y.
    ...
    - intros b l. simpl. 
      ...
      * rewrite !orb_true_iff, !andb_true_iff. intro. destruct H.
        ...
        { destruct H. apply negb_true_iff in H0. subst. right. easy. }
Qed. 
...
Proof.
  ...
  case_eq (size x =? size y); intros.
  - apply uge_list_ule_list in H0. unfold bv_ule. rewrite (@eqb_sym (size x) (size y)) in H. 
    rewrite H. apply H0. 
  - now contradict H0. 
Qed.
...
Lemma uge_list_big_endian_0 : forall (x : bitvector),
  uge_list_big_endian x (mk_list_false (length x)) = true.
Proof.
  intros x. pose proof (@ule_list_big_endian_0 x). 
  now apply ule_list_big_endian_uge_list_big_endian in H.
Qed.

Lemma bv_uge_0 : forall (x : bitvector), 
  bv_uge x (mk_list_false (length x)) = true.
Proof.
  intros x. pose proof (@bv_ule_0 x). now apply bv_ule_bv_uge in H. 
Qed.
    ...
    + assert ((n <? length a)%nat = true).
      ...
      * rewrite shl_one_bit_app.
        ...
        assert (((length (b :: l) - n)%nat = (S m)%nat)).
         { unfold m in *. case_eq n; intros. 
           - cbn. now rewrite Nat.sub_0_r.
           - cbn. Reconstr.rcrush (@Coq.Arith.PeanoNat.Nat.ltb_lt,
                                   @Coq.Arith.PeanoNat.Nat.sub_succ, @Coq.Init.Peano.le_S_n,
                                   @Coq.Arith.Minus.minus_Sn_m) 
                                  (@Coq.Init.Peano.lt, @Coq.Init.Datatypes.length). 
         }
        rewrite H2, removelast_firstn. easy.
        unfold m. Reconstr.rexhaustive1 (@Coq.Arith.PeanoNat.Nat.le_sub_l) 
                                        (@Coq.Init.Peano.lt, @m).
        ...
        Reconstr.rcrush (@Coq.Arith.PeanoNat.Nat.sub_gt,
                         @Coq.Arith.PeanoNat.Nat.sub_succ) 
                        (@Coq.Init.Datatypes.length). 
    + case_eq ((n <? length a)%nat); intros.
      * assert (length a = S n).
         { apply Nat.ltb_lt in H0.
           ...
           lia. } 
        rewrite H1. rewrite shl_one_bit_app.
...
Lemma shl_n_bits_a_0 : forall (b : bitvector), 
  shl_n_bits_a b (N.to_nat 0) = b.
Proof.
  intros b. simpl. unfold shl_n_bits_a.
...
(* skipn n0 (mk_list_false n0 ++ firstn (length a0 - n0) (a :: a0)) = 
   firstn (length a0 - n0) (a :: a0) *)
...
Proof. 
  ...
  - cbn. rewrite shr_n_shr_one_comm, IHn.
    unfold shr_n_bits_a. case_eq ((S n <? length a)%nat); intros.
    + assert ((n <? length a)%nat = true).
      { apply Nat.ltb_lt in H.
        apply Nat.ltb_lt. lia. }
      rewrite H0. cbn. case_eq a; intros.
      * subst. cbn in *. now contradict H.
      * assert (skipn n l ++ false :: mk_list_false n 
                = skipn n l ++ [false] ++ mk_list_false n) by easy.
        rewrite H2. rewrite app_assoc.
        specialize (@skip_n_one_bit n l b); intros.
        rewrite <- H3. rewrite shr_one_bit_append_false. easy.
...
(* 0 >> b = 0 *)
Lemma bvshr_zeros : forall (b : bitvector), 
                    bv_shr (zeros (size b)) b = zeros (size b).
Proof.
  intros b. induction b.
  + easy.
  + rewrite bv_shr_eq in *. unfold bv_shr_a in *.
    rewrite zeros_size in *. rewrite eqb_refl in *.
    unfold shr_n_bits_a in *. unfold size in *.
    unfold zeros in *. rewrite Nat2N.id in *.
    case_eq ((list2nat_be_a (a :: b) <? length (mk_list_false (length (a :: b))))%nat);
        intros comp_b_lenb.
    - apply skipn_nm_false. now rewrite length_mk_list_false in comp_b_lenb.
    - now rewrite length_mk_list_false.
Qed.


(* b >> 0 = b *)
Lemma bvshr_b_zeros : forall (b : bitvector), 
  bv_shr_a b (zeros (size b)) = b.
Proof.
  intros. unfold bv_shr_a. rewrite zeros_size.
  rewrite eqb_refl. unfold list2nat_be_a, zeros, size.
  rewrite Nat2N.id. rewrite list2N_mk_list_false.
  simpl. unfold shr_n_bits_a.
  case_eq (0 <? length b)%nat; intros.
...
Proof. 
  ...
  + simpl. case_eq n; intros.
    - easy.
    - simpl. now rewrite mk_list_false_cons.
...
Lemma mk_list_true_cons: forall n,
...
Proof. 
  ...
  + simpl. case_eq n; intros.
    - easy.
    - simpl. now rewrite mk_list_true_cons.
  + simpl. rewrite !app_assoc_reverse.
...
Proof. 
  intro a. induction a; intros.
  - now cbn.
  - cbn. now rewrite mk_list_true_cons.
Qed.
