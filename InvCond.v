...
Theorem bvshr_ugt_ltr : forall (n : N), forall (s t : bitvector), 
  (size s) = n -> (size t) = n ->
    (exists (x : bitvector), (size x = n) /\ bv_ugt (bv_shr_a x s) t = true) ->
    (bv_ult t (bv_shr_a (bv_not s) s) = true).
Proof. intros n s t Hs Ht (x, (Hx, H)).
        apply bv_ugt_bv_ult in H.
        rewrite bv_ult_nat in *.
        unfold bv_shr_a in *.
        rewrite bv_not_size with (n := n), Hs, N.eqb_refl.
        rewrite Hx, Hs, N.eqb_refl in H.
        unfold shr_n_bits_a, list2nat_be_a in *.
        assert ( length (bv_not s) = length x).
        unfold bv_not, bits.
        ...
        - rewrite H1 in *.
          ...
          rewrite mk_list_false_app_unit in *.
          destruct (nm_cases_all 
                     (N.to_nat (list2N (skipn (N.to_nat (list2N s)) (map negb s))))
                     (N.to_nat (list2N (skipn (N.to_nat (list2N s)) x)))).
          + specialize (@skipn_bvnot s); intros.
            unfold list2nat_be_a, bv_not, bits in H3.
            assert (N.to_nat (list2N s) < length s).
            unfold size in *.
            Reconstr.rsimple (@BV.BVList.RAWBITVECTOR_LIST.of_bits_size, 
              ...
              (@BV.BVList.RAWBITVECTOR_LIST.list2nat_be_a, 
               @BV.BVList.RAWBITVECTOR_LIST.bitvector).
            specialize (H3 H4). rewrite H3 in H2.
            contradict H2.
            specialize (@pow_ltb_false_gen (skipn (N.to_nat (list2N s)) (map negb s))
                         (skipn (N.to_nat (list2N s)) x)); intros.
            assert (length (skipn (N.to_nat (list2N s)) x) = 
                    length (skipn (N.to_nat (list2N s)) (map negb s))).
            { Reconstr.rcrush (@BV.BVList.RAWBITVECTOR_LIST.skipn_bvnot, 
                @BV.BVList.RAWBITVECTOR_LIST.length_skipn) 
               (@BV.BVList.RAWBITVECTOR_LIST.bitvector, 
                @BV.BVList.RAWBITVECTOR_LIST.list2nat_be_a).
            }
            specialize (H2 H5).
            assert ( (length (skipn (N.to_nat (list2N s)) (map negb s))) = 
                     (length s - N.to_nat (list2N s))).
            Reconstr.rcrush (@BV.BVList.RAWBITVECTOR_LIST.length_mk_list_true)
              (@BV.BVList.RAWBITVECTOR_LIST.bitvector).
            rewrite H6 in H2. Reconstr.reasy Reconstr.Empty Reconstr.Empty.
        ...
        - rewrite H1 in *. Reconstr.reasy Reconstr.Empty Reconstr.Empty.
        - easy.
        - Reconstr.reasy (@Coq.NArith.BinNat.N.eqb_refl, 
             @BV.BVList.RAWBITVECTOR_LIST.bv_shr_a_size) Reconstr.Empty.
        - rewrite bv_shr_a_size with (n := n).
          Reconstr.reasy (@Coq.NArith.BinNat.N.eqb_refl) Reconstr.Empty.
          Reconstr.reasy (@BV.BVList.RAWBITVECTOR_LIST.bv_not_size) Reconstr.Empty.
          easy.
Qed.
          ...
          + subst. assert (N.to_nat (list2N (zeros (N.pos p))) <? length s = true).
            ...
            ++ Reconstr.rsimple (@Coq.Lists.List.app_nil_r, 
                 ...
                 (@BV.BVList.RAWBITVECTOR_LIST.bv2nat_a, 
                  ...
                  @Coq.NArith.BinNatDef.N.of_nat, 
                  @BV.BVList.RAWBITVECTOR_LIST.bitvector).
          - pose proof (@zeros_size (size s)). rewrite Hs in H at 2.
            pose proof (@bv_ashr_a_size n s (zeros (size s)) Hs H).
            rewrite H0, Ht. now rewrite N.eqb_refl.
          - rewrite Hs, Ht. now rewrite N.eqb_refl.
          - assert ( (eqb (last s false) false) = true).
              ...
              ** assert (N.to_nat (list2N (zeros (size (mk_list_false (length s))))) <?
                  ...
                  Reconstr.rblast (@BV.BVList.RAWBITVECTOR_LIST.of_bits_size, 
                   ...
                   (@BV.BVList.RAWBITVECTOR_LIST.list2nat_be_a, 
                    ...
                    @BV.BVList.RAWBITVECTOR_LIST.size, 
                    @BV.BVList.RAWBITVECTOR_LIST.bv2nat_a).
              ** pose proof (@bv_ashr_a_size n (mk_list_false (length s)) 
                              (zeros (size (mk_list_false (length s)))) Hs).
                 rewrite Hs in H1. rewrite zeros_size in H1. assert (n = n) by easy.
                 specialize (@H1 H2). rewrite Hs. rewrite H1, Ht. now rewrite N.eqb_refl.
            + exists (mk_list_true (N.to_nat n)). 
              ...
              Reconstr.rblast (@BV.BVList.RAWBITVECTOR_LIST.gt0_nmk_list_false, 
               ...
               @BV.BVList.RAWBITVECTOR_LIST.zeros, 
               @BV.BVList.RAWBITVECTOR_LIST.bitvector). 
               pose proof (@length_mk_list_false (length s)). unfold size.
               rewrite Ht. rewrite H3. rewrite Hs. now rewrite N.eqb_refl.
             + rewrite (@zeros_size (size s)). now rewrite N.eqb_refl. 
             + unfold zeros, size. rewrite Nat2N.id.
...
Proof. intros. split.
        ...
        - unfold bv_ashr_a. 
          ...
          unfold size.
          rewrite <- H3. unfold size in H0. rewrite <- N2Nat.inj_iff in H0.
          rewrite Nat2N.id in H0. rewrite H0. now rewrite N.eqb_refl.
          unfold size in H. rewrite <- N2Nat.inj_iff in H.
          rewrite Nat2N.id in H. now rewrite H.
          unfold size in H1. rewrite <- N2Nat.inj_iff in H1.
          rewrite Nat2N.id in H1. now rewrite H1.
        ...
        - destruct H1 as (x, (H1, H2)).
          ...
          unfold size in H0. rewrite <- N2Nat.inj_iff in H0.
          rewrite Nat2N.id in H0. rewrite H0. now rewrite N.eqb_refl.
          unfold size in H. rewrite <- N2Nat.inj_iff in H.
          rewrite Nat2N.id in H. now rewrite H.
          unfold size in H1. rewrite <- N2Nat.inj_iff in H1.
        ...
        - rewrite H in Ha.
          ...
          ** rewrite bv_slt_ult_last_eq with (d := false) in Ha.
             ...
             Reconstr.reasy (@BV.BVList.RAWBITVECTOR_LIST.last_mk_list_false) 
              Reconstr.Empty.
          ** pose proof (@bv_ashr_a_size n s (mk_list_true (N.to_nat n)) Hs).
             pose proof (@length_mk_list_true (N.to_nat n)). rewrite Ht.
             unfold size in H1 at 1. rewrite <- N2Nat.inj_iff in H1.
             rewrite Nat2N.id in H1. specialize (@H1 H2). rewrite H1.
             now rewrite N.eqb_refl.
          + rewrite bv_slt_ult_last_eq with (d := false) in Ha.
            rewrite bv_ult_nat in Ha.
            destruct (list_cases_all_false s).
        ...
        - rewrite H in Ha.
          ...
          ** rewrite bv_slt_ult_last_eq with (d := false) in Ha.
             ...
             Reconstr.rcrush (@BV.BVList.RAWBITVECTOR_LIST.length_mk_list_false, 
               @BV.BVList.RAWBITVECTOR_LIST.bv2nat_gt0) 
               (@BV.BVList.RAWBITVECTOR_LIST.bitvector).
             rewrite Hs. unfold size. rewrite length_mk_list_false.
             unfold size in Hs. rewrite Hs. now rewrite N.eqb_refl.
             Reconstr.reasy (@BV.BVList.RAWBITVECTOR_LIST.last_mk_list_false) 
              Reconstr.Empty.
          ** pose proof (@bv_ashr_a_size n s (mk_list_true (N.to_nat n)) Hs).
             rewrite Ht. unfold size in H0 at 1. rewrite length_mk_list_true in H0.
             rewrite N2Nat.id in H0. assert (n = n) by easy. specialize (@H0 H1).
             rewrite H0. now rewrite N.eqb_refl. 
        - easy.
        - exists (zeros n). split.
          Reconstr.reasy (@BV.BVList.RAWBITVECTOR_LIST.zeros_size) Reconstr.Empty.
          apply bv_ult_bv_ugt.
...
Proof. intros.
        ...
        - unfold bv_ashr_a. rewrite H, H1, N.eqb_refl.
          unfold size in *.
          specialize (@length_ashr_aux_a s x (N.to_nat n)); intros.
          rewrite H0. rewrite <- N2Nat.inj_iff in H, H1. rewrite Nat2N.id in H, H1. 
          symmetry in H, H1. specialize (@H3 H H1). rewrite <- Nat2N.inj_iff in H3.
          rewrite N2Nat.id in H3. rewrite <- H3. now rewrite N.eqb_refl.
        - rewrite H0, H. now rewrite N.eqb_refl. 
Qed.
